      ...
      <div className="timeline">
        ...
        <div className="cards-container">
            ...
            <div className="timeline-card-content">
                ...
                <h3 style={{ color: "lightpink" }}>Sitel pvt ltd</h3>
                ...
                <h4 style={{ color: "lightpink" }}>June - September</h4>
                <span>2023</span>
                </div>
            </div>
            </div>
            ...
            <div className="timeline-card-content">
                ...
                <h3 style={{ color: "rgba(212, 91, 236, 0.548)" }}>Instrucko</h3>
                <span>Spanish Trainer</span>
                </div>
                <div className="timeline-card-6-back timeline-card-common timeline-card-back-common">
                <h4 style={{ color: "rgba(212, 91, 236, 0.548)" }}>May - Present</h4>
                <span>2024</span>
                </div>
            </div>
            </div>
            ...
            <div className="timeline-card-content">
                ...
                <h3 style={{ color: "#0099ff" }}>Amigable Institute</h3>
                <span>Spanish Trainer</span>
                </div>
                <div className="timeline-card-5-back timeline-card-common timeline-card-back-common">
                <h4 style={{ color: "#0099ff" }}>March - Present</h4>
                <span>2024</span>
                </div>
            </div>
            </div>
